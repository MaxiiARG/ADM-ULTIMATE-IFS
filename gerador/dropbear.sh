...
eth=$(ifconfig | grep -v inet6 | grep -v lo | grep -v 127.0.0.1 | grep "encap:Ethernet" | awk '{print $1}')
    ...
    read -p " [S/N]: " -e -i n sshsn
           ...
           [[ "$rx" = "" ]] && rx="999999999"
           echo -e " $(fun_trans "¿Cuál es la tasa TX")"
...
echo -e "\033[1;32m $(fun_trans "INSTALADOR DE DROPBEAR ADM-ULTIMATE-IFS")\n$barra"
echo -e "\033[1;31m $(fun_trans "Seleccione Puertos Válidos en orden secuencial:")\033[1;32m 22 80 81 82 85 90\033[1;37m"
echo -e "$barra"
echo -ne "\033[1;31m $(fun_trans "Introduzca el/los puerto"): \033[1;37m" && read DPORT
tput cuu1 && tput dl1
TTOTAL=($DPORT)
    for((i=0; i<${#TTOTAL[@]}; i++)); do
        ...
        echo -e "\033[1;33m $(fun_trans "Puerta Elegida:")\033[1;31m ${TTOTAL[$i]} FAIL"
        }
   done
  [[  -z $PORT ]] && {
  echo -e "\033[1;31m $(fun_trans "Ninguna Puerta valida fue elegida")\033[0m"
  return 1
  }
...
echo -e "${cor[3]} $(fun_trans "Su dropbear ha sido configurado con éxito")\n$barra"
#UFW
