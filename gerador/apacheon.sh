...
IP="$(fun_ip)"
echo -e "${cor[4]} [1] >${cor[3]} $(fun_trans "Colocar archivos en línea")"
echo -e "${cor[4]} [2] >${cor[3]} $(fun_trans "Quitar archivo en línea")"
echo -e "${cor[4]} [3] >${cor[3]} $(fun_trans "Ver vínculos de archivos en línea")"
echo -e "$barra"
