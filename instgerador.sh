...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL01heGlpQVJHL0FETS1VTFRJTUFURS1JRlMvdHJlZS9tYXN0ZXIvZ2VyYWRvcg=="
SUB_DOM='base64 -d'
rm $(pwd)/$0
ofus () {
unset txtofus
...
echo -ne "\033[1;33mBajando Archivos...\033[1;31m[$arqx] "
wget -O $HOME/$arqx ${REQUEST}/${arqx} > /dev/null 2>&1 && {
echo -e "\033[1;31m- \033[1;32mRecibido con suceso!"
[[ -e $HOME/$arqx ]] && veryfy_fun $arqx
} || echo -e "\033[1;31m- \033[1;31mFallo (no recibido!)"
done
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/MaxiiARG/ADM-ULTIMATE-IFS/master/Install/trans?dl=0 &> /dev/null
...
echo -e "\033[1;36m--------------------------------------------------------------------\033[0m"
echo -e "\033[1;33mLLAVE INVALIDA!"
echo -e "\033[1;36m--------------------------------------------------------------------\033[0m"
}
echo -ne "\033[0m"
